"""
    ...
    You have to write a function printer_error which given a string will return the error rate of the printer as a string representing a rational whose numerator is the number of
...
def printer_error(s):
    ...
    numerator = 0
    for char in s:
        if char not in "abcdefghijklm" or not char.isalpha():
            numerator += 1
